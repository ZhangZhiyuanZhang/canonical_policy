...
from canonical_policy.model.diffusion.canonical_conditional_unet1d_rel import CanonicalConditionalUnet1DRel
...
class DiffusionCanonicalUNetRelPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
